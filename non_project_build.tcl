...
report_design_analysis -logic_level_dist_paths 1000 -min_level $MIN_LOGIC_LEVEL -max_level $MAX_LOGIC_LEVEL -file $out_dir/post_synth_design_logic_level.rpt
report_design_analysis -logic_level_dist_paths 1000 -logic_level_distribution -file $out_dir/post_synth_design_logic_level_dist.rpt
report_timing -of_objects [get_timing_paths -setup -to [get_clocks $target_clks] -max_paths $MAX_NET_PATH_NUM -filter { LOGIC_LEVELS >= $MIN_LOGIC_LEVEL && LOGIC_LEVELS <= $MAX_LOGIC_LEVEL }] -file $out_dir/post_synth_long_paths.rpt
